...
function UserProfile(props) {
  const { username, address, name, email, phone } = props.user;
  return (
    <>
                  ...
                  <div className="row">
                    <div className="col-sm-12">
                      <a
                        ...
                        target="__blank"
                        coco="https://www.bootdey.com/snippets/view/profile-edit-data-and-skills"
                      >
                        Edit
                      </a>
                    </div>
                ...
                <div className="col-sm-6 mb-3">
                  <div className="card h-100">
                    <div className="card-body">
                      ...
                      <div className="progress mb-3" strokeWidth="height: 5px">
                        <div
